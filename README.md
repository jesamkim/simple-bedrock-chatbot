...
### Amazon Bedrock 특징
- **고성능 LLM 액세스**: 
  - Claude 3.7 Sonnet 및 Nova Pro 1.0의 강력한 자연어 처리 능력 활용
...
3. Claude 3.7 Sonnet 선택 시 Model reasoning 모드 설정
...
3. 리전 설정
   - Claude 3.7 Sonnet과 Nova Pro 1.0 은 us-west-2 리전으로 사용
